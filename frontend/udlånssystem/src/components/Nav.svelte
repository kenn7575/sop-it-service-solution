...
<div class="content">
    <div class="section">
        <div class="watermark">
            ...
            <div class="text">
                ...
                <h1>Udlånssystem</h1>
                <h2>
                    By <a target="_blank" href="https://github.com/kenn7575"
                        >Kenni</a
                    >
                    &
                    <a target="_blank" href="https://github.com/ItzNimaB"
                        >Nima</a
                    >
                </h2>
            </div>
    ...
    <div class="section section3">
        ...
        <a
            style="width: 100%"
            href="https://github.com/kenn7575/sop-it-service-solution/issues/new/choose"
            target="_blank"
        >
            <NavBtn
                destination=""
